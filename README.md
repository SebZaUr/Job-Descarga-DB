# CGMP-CO-JSPRK-DIAT03NP0L01-V00
...
```java
- /tmp/git-projects/23cc547d-f7e8-4c42-b923-e48657c7a936
| - local-execution
  | - database
...
- Folder **src** contains the java files:
  - **JobDiat03np0l01Builder.java**: Indicates the sources and targets the generated application
